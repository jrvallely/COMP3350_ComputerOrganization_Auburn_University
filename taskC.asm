...
# TODO: Task c: draw another rectangle (parameters: x1=400, width is 30, y1=50,
# height=120)
li $a0,400       # x1 = 400
li $a1,30        # width = 30
li $a2,50        # y1 = 50
li $a3,120       # height = 120
jal rectangle    # draw the second rectangle
...
rectangleYloop:
    move $t3,$a2             # set t3 to start of current row
rectangleXloop:
    ...
    add $a2,$a2,$t4          # advance one row (left-edge pointer)
    add $t2,$t2,$t4          # advance one row (right-edge pointer)
